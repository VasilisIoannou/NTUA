...
// The next line to print must be protexted by a mutex, so it is incremented correctly
int next_line = 0;

//Initialiase the mutax and the cond
...
void compute_and_output_mandel_line(int fd, int current_line) 
{
    ...
    // Signal if this is the next line needed
